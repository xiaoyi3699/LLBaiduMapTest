...
- (instancetype)init {
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithRed:20/255. green:20/255. blue:20/255. alpha:.5];
    }
    return self;
}

- (void)popUpView:(UIView *)view animationStyle:(LLAnimationStyle)animationStyle duration:(NSTimeInterval)duration completion:(void(^)())completion{
